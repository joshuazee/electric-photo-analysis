    ...
    <a-row style="margin-top: 10px">
      ...
      <a-col :span="10" style="padding: 10px">
        <div style="height: 100%">
          ...
          <a-image
            width="100%"
            :src="'api/file/get?flag=&path=' + activeFile.path"
      ...
      <a-col :span="10" style="padding: 10px">
        <div style="height: 100%">
          ...
          <a-image
            width="100%"
            :src="'api/file/get?flag=true&path=' + resultFilePath"
            fallback="data:image/png;base64,"
          />
        </div>
      </a-col>
...
const changeFileActive = (file: any, index: number) => {
  ...
  if (file.name !== activeFile.name) {
    ...
    if (resultList.value.length > index) {
      ...
      resultFilePath.value = resultImageList.value[index]
    }
  }
}
  ...
  axios
    ...
    .then((response) => {
      ...
      if (result.code === 200) {
        ...
        resultImageList.value = result.data[0]
        resultList.value = result.data[1]
      }
      console.log(result)
    })
}
